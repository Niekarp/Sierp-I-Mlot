...
namespace xo
{
	namespace conf
	{
		...
		const int GAME_HERO_PROGRESS_PENALTY_DROP = -5;
		const int GAME_HERO_PROGRESS_PENALTY_WRONG_CLICK = -10;
		const int GAME_HERO_PROGRESS_REWARD_GOOD_CLICK = 4;
		const int GAME_HERO_TURN_LENGTH = 20000;
